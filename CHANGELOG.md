...
- [ ] School's own history page is empty (*বিস্তারিত আসছে...*), so the founding narrative must come from the committee.
...
- `docs/15-roadmap.md` — post-2026 extensibility, and explicitly what *not* to build
