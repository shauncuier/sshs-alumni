...
return [
    ...
    'join' => [
        ...
        'otp' => [
            'send_code' => 'Send OTP',
            'sending' => 'Sending OTP...',
            'resend_code' => 'Resend in :seconds s',
            'resend_ready' => 'Resend OTP',
            'verify' => 'Verify Code',
            'verifying' => 'Verifying...',
            'verified' => 'Phone number verified',
            'change_number' => 'Change number',
            'code_sent' => 'Enter the 6-digit OTP code sent to :phone',
            'code_placeholder' => '6-digit OTP',
            'must_verify' => 'Please verify your mobile number with SMS OTP before continuing.',
            'sent_success' => 'Verification code sent via SMS.',
            'verify_success' => 'Phone number verified successfully.',
            'invalid_number' => 'Please enter a valid Bangladeshi mobile number (01XXXXXXXXX).',
            'invalid_code' => 'Invalid verification code. :remaining attempts remaining.',
            'expired_or_missing' => 'Verification code expired or not found. Please request a new one.',
            'too_many_attempts' => 'Too many requests. Please wait a few minutes before trying again.',
            'cooldown_active' => 'Please wait :seconds seconds before requesting another code.',
            'max_attempts_reached' => 'Too many failed attempts. Please request a new code.',
            'send_failed' => 'Failed to dispatch SMS. Please try again.',
        ],
    ],
