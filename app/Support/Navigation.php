...
final class Navigation
{
    ...
    private const ADMIN = [
        ...
        'money' => [
            ...
            ['key' => 'fundraising', 'route' => 'admin.fundraising.index', 'icon' => 'Gift', 'permission' => 'donations.view'],
        ...
        'content' => [
            ...
            ['key' => 'businesses', 'route' => 'admin.businesses.index', 'icon' => 'Building', 'permission' => 'content.view'],
            ['key' => 'jobs', 'route' => 'admin.jobs.index', 'icon' => 'Briefcase', 'permission' => 'content.view'],
        ],
        'communication' => [
        ...
        'system' => [
            ...
            ['key' => 'certificates', 'route' => 'admin.certificates.index', 'icon' => 'Award', 'permission' => 'members.view'],
    ...
    private const MEMBER = [
        ...
        ['key' => 'donors', 'route' => 'donors.index', 'icon' => 'HeartHandshake', 'approved' => true],
        ['key' => 'jobs', 'route' => 'jobs.index', 'icon' => 'Briefcase', 'approved' => true],
        ['key' => 'mentorship', 'route' => 'mentorship.index', 'icon' => 'GraduationCap', 'approved' => true],
        ['key' => 'businesses', 'route' => 'my.businesses', 'icon' => 'Building', 'approved' => true],
        ['key' => 'certificates', 'route' => 'my.certificates', 'icon' => 'Award', 'approved' => true],
    ...
    private const PUBLIC_PRIMARY = [
        ...
        ['key' => 'campaigns', 'route' => 'campaigns.index'],
        ['key' => 'businesses', 'route' => 'businesses.index'],
