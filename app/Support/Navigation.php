...
final class Navigation
{
    ...
    private const ADMIN = [
        ...
        'content' => [
            ['key' => 'news', 'route' => 'admin.news.index', 'icon' => 'Newspaper', 'permission' => 'content.manage'],
            ['key' => 'announcements', 'route' => 'admin.announcements.index', 'icon' => 'Megaphone', 'permission' => 'content.manage'],
            ['key' => 'gallery', 'route' => 'admin.gallery.index', 'icon' => 'Image', 'permission' => 'content.manage'],
            ['key' => 'pages', 'route' => 'admin.pages.index', 'icon' => 'FileText', 'permission' => 'content.manage'],
            ['key' => 'history', 'route' => 'admin.history.index', 'icon' => 'ScrollText', 'permission' => 'content.manage'],
